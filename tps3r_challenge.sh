...
<VirtualHost *:80>
        DocumentRoot /var/www/html/challenge-tps3r/public
        <Directory /var/www/html/challenge-tps3r>
                AllowOverride All
        </Directory>
</VirtualHost>
EOF
...
cd /var/www/html
sudo git clone https://github.com/davidmartinusp/challenge_tps3r.git
cd challenge_tps3r/
